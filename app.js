(() => {
    ...
    const SIGNAL_URL = 'https://signal.me/#eu/z1xwC4StgdSSkEESKkcssaUnyNl8kd2fEaKr8MiuQD1ruhnkqklA0L5G05qo-V5-';
    ...
    const products = [
      ...
      { video: 'media/p2.mp4', title: 'Cali USA 🇺🇸⭐⭐⭐⭐', description: 'STRAIN: ZKITTLEZ\n70/30% • INDICA/SATIVA\n5G 40\n10G 75\n20G 140\nPER QUANTITÀ MAGGIORI: CONTATTO PRIVATO', online: true, quanti: [{ peso: '5G', prezzo: '40' }, { peso: '10G', prezzo: '75' }, { peso: '20G', prezzo: '140' }] },
    ...
    products.forEach((product, index) => {
      ...
      const detailLines = product.description
        ? String(product.description).split('\n').filter(Boolean).map((line) => {
            const price = line.match(/^(\d+\s*G)\s*[.:]?\s*(.+)$/i);
            return price
